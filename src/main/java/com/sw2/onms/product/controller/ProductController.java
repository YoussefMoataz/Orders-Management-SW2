...
public class ProductController {
    ...
    Product updateProduct(@PathVariable long serialNumber, @RequestBody Product product) {
        return productsService.updateProduct(serialNumber, product);
    }

    @DeleteMapping("/delete/{serialNumber}")
    Product deleteProduct(@PathVariable long serialNumber) {
        return productsService.deleteProduct(serialNumber);
    }

    @GetMapping("/search/serial/{serialNumber}")
    Product getProductBySerialNumber(@PathVariable long serialNumber) {
        return productsService.getProductBySerialNumber(serialNumber);
    }
    ...
    List<Product> getAvailableProducts() {
        return productsService.getAvailableProducts();
    }
}
