...
public class TemplateRepo {
    ...
    TemplateRepo() {
        ...
        orderPlacement.add(ordPlacementTemplate1);
        orderPlacement.add(ordPlacementTemplate2);
        ...
        orderShipment.add(ordShipmentTemplate1);
        orderShipment.add(ordShipmentTemplate2);
